...
namespace mage {
	...
	public:
		...
		/**
		 ...
		 @param[in]		scale
						The scale component.
		 */
		explicit S1ETTransform3D(const F32x3& translation = { 0.0f, 0.0f, 0.0f },
			                     const F32x3& rotation    = { 0.0f, 0.0f, 0.0f },
	...
	public:
		 ...
		 */
		explicit SETTransform3D(const F32x3& translation = { 0.0f, 0.0f, 0.0f },
			                    const F32x3& rotation    = { 0.0f, 0.0f, 0.0f },
