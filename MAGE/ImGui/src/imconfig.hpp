...
// Defining those options in imconfig.hpp will ensure every compilation unit gets to see the same data structure layouts.
...
//#define IMGUI_DISABLE_MATH_FUNCTIONS                      // Don't implement ImFabs/ImSqrt/ImPow/ImFmod/ImCos/ImSin/ImAcos/ImAtan2 wrapper so you can implement them yourself. Declare your prototypes in imconfig.hpp.
