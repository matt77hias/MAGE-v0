...
// Note that you can #define IMGUI_DISABLE_DEMO_WINDOWS in imconfig.hpp for the same effect.
// If you want to link core ImGui in your final builds but not those demo windows, #define IMGUI_DISABLE_DEMO_WINDOWS in imconfig.hpp and those functions will be empty.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // Define IM_VEC2_CLASS_EXTRA in imconfig.hpp to create implicit conversions between your types and ImVec2/ImVec4.
