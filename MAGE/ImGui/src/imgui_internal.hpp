...
// This is going to be exposed in imgui.hpp when stabilized enough.
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImDrawList*             DrawList;                           // == &DrawListInst (for backward compatibility reason with code using imgui_internal.hpp we keep this a pointer)
