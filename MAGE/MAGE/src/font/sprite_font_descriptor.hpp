...
namespace mage {
	...
	public:
		...
		*/
		...
		/**
		 ...
		 @param[in]		desc
						A reference to the sprite font descriptor to copy.
		 @return		A reference to the copy of the given sprite font descriptor
						(i.e. this sprite font descriptor).
		 */
		...
		/**
		 ...
		 @param[in]		desc
						A reference to the sprite font descriptor to move.
		 @return		A reference to the moved sprite font descriptor
						(i.e. this sprite font descriptor).
		 */
		...
		/**
		 Checks whether working around gamma issues is needed 
		 according to this sprite font descriptor.
	...
	private:
		...
		/**
		 A flag indicating whether working around gamma issues is needed 
		 for this sprite font descriptor. 
