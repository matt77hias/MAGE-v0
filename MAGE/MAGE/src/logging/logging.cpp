...
namespace mage {
	...
	/**
	 Handler callback for handling the user closing the console 
	 (either by clicking Close on the console window's window menu, 
	...
	void InitializeConsole() {
		...
		const BOOL result = SetConsoleCtrlHandler(ConsoleCloseHandler, TRUE);
		Assert(result);
