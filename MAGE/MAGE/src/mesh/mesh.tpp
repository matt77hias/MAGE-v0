...
namespace mage {
	...
	Mesh::Mesh(ID3D11Device2 &device, const VertexT *vertices, size_t nb_vertices, const uint32_t *indices, size_t nb_indices)
	...
	template < typename VertexT >
	HRESULT Mesh::InitializeMesh(ID3D11Device2 &device, const VertexT *vertices, const uint32_t *indices) {
	...
	inline void Mesh::Render(ID3D11DeviceContext2 &device_context) const {
