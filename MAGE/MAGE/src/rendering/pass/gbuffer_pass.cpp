...
namespace mage {
	...
	GBufferPass::GBufferPass(GBufferPass &&pass) noexcept = default;

	GBufferPass::~GBufferPass() = default;

	void GBufferPass::BindFixedState() const noexcept {
	...
	void XM_CALLCONV GBufferPass ::BindModelData(FXMMATRIX object_to_view, 
	...
	void XM_CALLCONV GBufferPass::Render(const Scene &scene, 
