...
namespace mage {
	...
	/**
	 ...
	 @tparam		T		The type of resources.
	*/
	template< typename T >
	...
	public:
		...
		/**
		 ...
		 @param[in]		name		A reference to the name of the new resource.
		 @param[in]		path		A reference to the path of the new resource.
		...
		/**
		 ...
		 @param[in]		resource	A pointer to a pointer of the resource.
		 */
