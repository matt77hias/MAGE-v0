...
namespace mage {
	...
	const CombinedShader CreateEmissiveShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_EMISSIVE, cps.get());
	...
	const CombinedShader CreateLambertianShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_LAMBERTIAN, cps.get());
	...
	const CombinedShader CreatePhongShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_PHONG, cps.get());
	...
	const CombinedShader CreateModifiedPhongShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_MODIFIED_PHONG, cps.get());
	...
	const CombinedShader CreateBlinnPhongShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_BLINN_PHONG, cps.get());
	...
	const CombinedShader CreateModifiedBlinnPhongShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_MODIFIED_BLINN_PHONG, cps.get());
	...
	const CombinedShader CreateWardShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_WARD, cps.get());
	...
	const CombinedShader CreateWardDuerShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_WARD_DUER, cps.get());
	...
	const CombinedShader CreateCookTorranceShader() {
		...
		SharedPtr< PixelShader >  ps    = GetOrCreateBasicPixelShader(MAGE_GUID_PS_COOK_TORRANCE, cps.get());
