...
namespace mage {
	...
	const CombinedShader CreateEmissiveShader() {
		...
		SharedPtr< VertexShader > vs   = CreateBasicVertexShader(MAGE_GUID_VS_TRANSFORM, cvs);
		
		const CompiledPixelShader cps  = CreateCompiledEmissivePixelShader();
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_EMISSIVE, cps);
	...
	const CombinedShader CreateLambertianShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_LAMBERTIAN, cps);
	...
	const CombinedShader CreatePhongShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_PHONG, cps);
	...
	const CombinedShader CreateModifiedPhongShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_MODIFIED_PHONG, cps);
	...
	const CombinedShader CreateBlinnPhongShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_BLINN_PHONG, cps);
	...
	const CombinedShader CreateModifiedBlinnPhongShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_MODIFIED_BLINN_PHONG, cps);
	...
	const CombinedShader CreateWardShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_WARD, cps);
	...
	const CombinedShader CreateWardDuerShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_WARD_DUER, cps);
	...
	const CombinedShader CreateCookTorranceShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateBasicPixelShader(MAGE_GUID_PS_COOK_TORRANCE, cps);
