...
namespace mage {
	...
	const CombinedShader CreateLambertianTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_LAMBERTIAN, cps.get());
	...
	const CombinedShader CreatePhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_PHONG, cps.get());
	...
	const CombinedShader CreateModifiedPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_MODIFIED_PHONG, cps.get());
	...
	const CombinedShader CreateBlinnPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_BLINN_PHONG, cps.get());
	...
	const CombinedShader CreateModifiedBlinnPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_MODIFIED_BLINN_PHONG, cps.get());
	...
	const CombinedShader CreateWardTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_WARD, cps.get());
	...
	const CombinedShader CreateWardDuerTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_WARD_DUER, cps.get());
	...
	const CombinedShader CreateCookTorranceTSNMShader() {
		...
		SharedPtr< PixelShader >  ps    = ResourceManager::Get()->GetOrCreateTSNMPixelShader(MAGE_GUID_PS_TSNM_COOK_TORRANCE, cps.get());
