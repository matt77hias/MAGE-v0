...
namespace mage {
	...
	const CombinedShader CreateLambertianTSNMShader() {
		...
		SharedPtr< VertexShader > vs   = CreateTSNMVertexShader(MAGE_GUID_VS_TRANSFORM, cvs);

		const CompiledPixelShader cps  = CreateCompiledLambertianTSNMPixelShader();
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_LAMBERTIAN, cps);
	...
	const CombinedShader CreatePhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_PHONG, cps);
	...
	const CombinedShader CreateModifiedPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_MODIFIED_PHONG, cps);
	...
	const CombinedShader CreateBlinnPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_BLINN_PHONG, cps);
	...
	const CombinedShader CreateModifiedBlinnPhongTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_MODIFIED_BLINN_PHONG, cps);
	...
	const CombinedShader CreateWardTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_WARD, cps);
	...
	const CombinedShader CreateWardDuerTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_WARD_DUER, cps);
	...
	const CombinedShader CreateCookTorranceTSNMShader() {
		...
		SharedPtr< PixelShader >  ps   = CreateTSNMPixelShader(MAGE_GUID_PS_TSNM_COOK_TORRANCE, cps);
