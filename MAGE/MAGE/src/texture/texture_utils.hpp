...
namespace mage {
	...
	/**
	 ...
	 @param[in]		texture_srv
					A pointer to the (texture) shader resource view.
	 @return		@c true if and only if the given texture contains
					an alpha component.
	 */
	...
	/**
	 ...
	 @return		@c true if and only if the given 1D texture contains
					an alpha component.
	 */
	...
	/**
	 ...
	 @param[in]		texture
					A pointer to the 2D texture.
	 @return		@c true if and only if the given 2D texture contains
 					an alpha component.
	 */
	...
	/**
	 ...
	 @return		@c true if and only if the given 3D texture contains
					an alpha component.
	 */
