...
namespace mage::loader {
	...
	void VARReader::ReadLine(NotNull< zstring > line) {
		...
		else if (str_equals(token, g_var_token_F32)) {
			ReadVARVariable< F32 >();
		}
		else if (str_equals(token, g_var_token_F32x2)) {
			ReadVARVariable< F32, 2 >();
		}
		else if (str_equals(token, g_var_token_F32x3)) {
			ReadVARVariable< F32, 3 >();
		}
		else if (str_equals(token, g_var_token_F32x4)) {
			ReadVARVariable< F32, 4 >();
		}
		else if (str_equals(token, g_var_token_S32)) {
			ReadVARVariable< S32 >();
		}
		else if (str_equals(token, g_var_token_S32x2)) {
			ReadVARVariable< S32, 2 >();
		}
		else if (str_equals(token, g_var_token_S32x3)) {
			ReadVARVariable< S32, 3 >();
		}
		else if (str_equals(token, g_var_token_S32x4)) {
			ReadVARVariable< S32, 4 >();
		}
		else if (str_equals(token, g_var_token_U32)) {
			ReadVARVariable< U32 >();
		}
		else if (str_equals(token, g_var_token_U32x2)) {
			ReadVARVariable< U32, 2 >();
		}
		else if (str_equals(token, g_var_token_U32x3)) {
			ReadVARVariable< U32, 3 >();
		}
		else if (str_equals(token, g_var_token_U32x4)) {
